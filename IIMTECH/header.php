...
<?php } ?>
	...
	<body <?php body_class(); ?> style="<?php if( is_page_template("template-homepage.php") || is_page_template("template-bigbig.php")  || is_page_template("template-aboutus.php")   ){ ?> background-color:#000 !important; color:#fff !important; <?php } else { ?> background-color:#fff !important; color:#000  !important; <?php } ?>">
...
<?php
	...
	<section id="<?php if( is_page_template("template-homepage.php") || is_page_template("template-aboutus.php") || is_page_template("template-bigbig.php") ){ ?>bigbg<?php }?>" class="<?php if(! is_page_template("template-homepage.php") ||   is_page_template("template-aboutus.php") ){ ?>
			 biggy <?php }?>"  style="<?php if( is_page_template("template-aboutus.php") ){ ?> background-image: url(/wp-content/themes/IIMTECH/images/Aboutus.jpg); <?php } ?>   <?php if( is_page_template("template-bigbig.php") ){ ?> background-image: url( <?php the_field( 'bigbg' ) ?> ); <?php } ?>">
